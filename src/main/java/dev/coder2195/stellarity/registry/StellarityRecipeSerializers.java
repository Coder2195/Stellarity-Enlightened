...
public interface StellarityRecipeSerializers {
	...
	RecipeSerializer<CauldronCraftingRecipe> CAULDRON_CRAFTING = registerSerializer("cauldron_crafting", new RecipeSerializer<>(CauldronCraftingRecipe.CODEC, CauldronCraftingRecipe.STREAM_CODEC));
