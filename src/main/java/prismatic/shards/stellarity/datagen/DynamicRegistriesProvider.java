...
public class DynamicRegistriesProvider extends FabricDynamicRegistryProvider {
  ...
  public void configure(HolderLookup.@NonNull Provider provider, @NonNull Entries entries) {
    for (var registry : List.of(JUKEBOX_SONG, NOISE, PAINTING_VARIANT, COW_VARIANT, FROG_VARIANT, CAT_VARIANT, WOLF_VARIANT, PIG_VARIANT, CHICKEN_VARIANT, VOIDED_SKELETON_VARIANT, CONFIGURED_FEATURE, PLACED_FEATURE, BIOME, VILLAGER_TRADE, TRADE_SET, DAMAGE_TYPE)) {
