...
public class VillageTradeTagProvider extends FabricTagsProvider<VillagerTrade> {
	...
	protected void addTags(HolderLookup.@NonNull Provider provider) {
		...
		addTags(ARMORER_LEVEL_1_2, ARMORER_1_ENDERITE_SHARD_SPECIAL_IRON_CHESTPLATE, ARMORER_1_ENDERITE_SHARD_SPECIAL_IRON_HELMET);
		addTags(ARMORER_LEVEL_2, ARMORER_2_ENDERITE_SHARD_SPECIAL_IRON_BOOTS, ARMORER_2_ENDERITE_SHARD_SPECIAL_IRON_LEGGINGS);
		...
		addTags(ARMORER_LEVEL_4, ARMORER_4_PURPUR_BLOCK_ENDERITE_SHARD_ENDERITE_UPGRADE_SMITHING_TEMPLATE, ARMORER_4_ENDERITE_SHARD_SPECIAL_DIAMOND_LEGGINGS, ARMORER_4_ENDERITE_SHARD_SPECIAL_DIAMOND_BOOTS);
		addTags(ARMORER_LEVEL_5, ARMORER_5_ENDERITE_SHARD_SPECIAL_DIAMOND_CHESTPLATE, ARMORER_5_ENDERITE_SHARD_SPECIAL_DIAMOND_HELMET);

		addTags(BUTCHER_LEVEL_1, BUTCHER_1_ENDERMAN_FLESH_ENDERITE_SHARD);
		addTags(BUTCHER_LEVEL_2, BUTCHER_2_CHARCOAL_ENDERITE_SHARD, BUTCHER_2_CHARCOAL_ENDERITE_SHARD);
		...
		addTags(BUTCHER_LEVEL_3, BUTCHER_3_SHULKER_BODY_ENDERITE_SHARD);
		addTags(BUTCHER_LEVEL_4, BUTCHER_4_ENDERITE_SHARD_DRIED_KELP_BLOCK);
		addTags(BUTCHER_LEVEL_5, BUTCHER_5_ENDERITE_SHARD_SHEPHERDS_PIE);
	}
}
