...
public class DragonBreathCauldronIngredientRenderer extends EntityRenderer<DragonBreathCauldronIngredient, DragonBreathCauldronIngredientRenderer.DragonBreathCauldronItemEntityRenderState> {
	...
	@Override
	public void extractRenderState(DragonBreathCauldronIngredient entity, DragonBreathCauldronItemEntityRenderState state, float partialTicks) {
