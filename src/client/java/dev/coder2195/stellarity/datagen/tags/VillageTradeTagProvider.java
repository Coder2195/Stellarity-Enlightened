...
public class VillageTradeTagProvider extends FabricTagsProvider<VillagerTrade> {
	...
	protected void addTags(HolderLookup.@NonNull Provider provider) {
		...
		addTags(ARMORER_LEVEL_2, ARMORER_2_ENDERITE_SHARD_IRON_BOOTS, ARMORER_2_ENDERITE_SHARD_IRON_LEGGINGS);
		...
		addTags(BUTCHER_LEVEL_4, BUTCHER_5_ENDERITE_SHARD_DRIED_KELP_BLOCK);
