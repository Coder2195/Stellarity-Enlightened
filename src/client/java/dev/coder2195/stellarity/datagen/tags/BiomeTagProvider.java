...
public class BiomeTagProvider extends FabricTagsProvider<Biome> {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		builder(HAS_STRUCTURE_END_VILLAGE).add(THE_HALLOW, PRISMATIC_DUNES, HALLOWED_TUNDRA, END_HIGHLANDS, PRISMARINE_FOREST, AMETHYST_FOREST, END_MIDLANDS, ENDLESS_DUNES, WARPED_MARSH, FROZEN_MARSH);
