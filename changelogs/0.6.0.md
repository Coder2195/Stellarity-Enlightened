...
- Implemented elytra dyeing in the Altar of the Accursed
- New recipe type `altar_of_the_accursed_dye` is available for use in datapacks, which is used for elytra dyeing on the
