...
loot_tables = ["dungeon", "exit_portal", "campsite/trash", "campsite/food", "campsite/tent", "campsite/tent_2",
               ...
               "end_village/apiary", "end_village/archer_tower", "end_village/armorer", "end_village/butcher", "end_village/cartographer", "end_village/cartographer_shulker_box", "end_village/cleric", "end_village/fisherman", "end_village/fisherman_shulker_box", "end_village/fletcher", "end_village/fletcher_shulker_box", "end_village/leatherworker", "end_village/librarian", "end_village/market", "end_village/mason", "end_village/shepherd", "end_village/shepherd_shulker_box",
               "end_village/toolsmith", "end_village/tree_farm_1", "end_village/tree_farm_2", "end_village/weaponsmith",
